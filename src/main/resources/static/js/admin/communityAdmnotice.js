...
document.getElementById("selectAll").addEventListener("change", function() {
    let checkboxes = document.querySelectorAll(".ACaNcheckbox");
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    let totalItems = document.querySelectorAll(".ACaNboard tbody tr").length; // 전체 데이터 개수
    let totalPages = Math.ceil(totalItems / itemsPerPage); // 전체 페이지 수

    function showPage(page) {
        let rows = document.querySelectorAll(".ACaNboard tbody tr");
